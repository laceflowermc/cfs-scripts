...
<recipetype:create:milling>.addRecipe("ores_gravel_milling", [<item:exnihilosequentia:piece_iron> % 15, <item:exnihilosequentia:piece_gold> % 15, <item:exnihilosequentia:piece_copper> % 15, <item:exnihilosequentia:piece_zinc> % 15], <item:minecraft:gravel>);
...
<recipetype:create:milling>.addRecipe("ores_sand_milling", [<item:exnihilosequentia:piece_iron> % 20, <item:exnihilosequentia:piece_gold> % 20, <item:minecraft:prismarine_crystals> % 2, <item:minecraft:prismarine_shard> % 5], <item:minecraft:sand>);
...
<recipetype:create:milling>.addRecipe("ores_cnr_milling", [<item:exnihilosequentia:piece_gold> % 15, <item:minecraft:quartz> % 10, <item:minecraft:netherite_scrap> % 1], <item:exnihilosequentia:crushed_netherrack>);
