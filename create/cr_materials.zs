...
// Scintillating Ash
<recipetype:create:milling>.addRecipe("scintillating_ash_milling", [<item:ashenwheat:scintillating_ash>, <item:ashenwheat:scintillating_ash> % 45], <item:ashenwheat:ash_wheat_sheaf>);
// Amdesite Alloy
